namespace VariableBpm
{
    ...
    {
        public static string Font, VariableBpmManual, VariableBpmImport, VariableBpmExport, VariableBpmSettings, Interval, AutoStart, OK, VariableBpmEnable, VariableBpmDisable, ChangeBpmTo, InsertFromFile;
        ...
        public static void Localize()
        {
            switch (Common.Settings.CurrentLanguage)
            {
                case "zh":
                    ...
                    VariableBpmManual = "可变 BPM - 手动"; VariableBpmImport = "可变 BPM - 从文件导入"; VariableBpmExport = "可变 BPM - 从文件导出"; VariableBpmSettings = "可变 BPM - 设置"; Interval = "间隔 (ms)"; AutoStart = "启动工程时默认启用"; OK = "确定";
                    VariableBpmEnable = "可变 BPM - 启用"; VariableBpmDisable = "可变 BPM - 禁用"; ChangeBpmTo = "改变 BPM 至 {0}";
                    InsertFromFile = "从 {0} 插入 BPM";
                ...
                default:
                    ...
                    InsertFromFile = "Insert BPM From {0}";
                    FileDialogFilters = new string[]
                    {
